...
CREATE TABLE `orders` (
   ...
   CONSTRAINT `fk_orders_users1` FOREIGN KEY (`users_id`)
      REFERENCES `users` (`id`)
      ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- Ullman, Larry. Effortless E-Commerce with PHP and MySQL (Voices That Matter) (Kindle Locations 1740-1743). Pearson Education. Kindle Edition. 